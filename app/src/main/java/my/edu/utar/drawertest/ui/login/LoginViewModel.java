...
import my.edu.utar.drawertest.data.Result;
...
//            loginResult.setValue(new LoginResult(new LoggedInUserView(data.getDisplayName(), data.getUserId(), data.getEmail(), data.isTeacher(), data.ge)));
//        } else {
